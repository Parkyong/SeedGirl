...
#define kTouchToRecord @"按住 说话"//NSLocalizedString(@"message.toolBar.record.touch", @"hold down to talk")
#define kTouchToFinish @"松开 结束"//NSLocalizedString(@"message.toolBar.record.send", @"loosen to send")
