...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _textLabel.text = @"手指上滑, 取消发送";//NSLocalizedString(@"message.toolBar.record.upCancel", @"Fingers up slide, cancel sending");
...
{
    _textLabel.text = @"手指上滑取消发送";//NSLocalizedString(@"message.toolBar.record.upCancel", @"Fingers up slide, cancel sending");
    _textLabel.backgroundColor = [UIColor clearColor];
}
...
{
    _textLabel.text = @"手指上滑取消发送";//NSLocalizedString(@"message.toolBar.record.loosenCancel", @"loosen the fingers, to cancel sending");
