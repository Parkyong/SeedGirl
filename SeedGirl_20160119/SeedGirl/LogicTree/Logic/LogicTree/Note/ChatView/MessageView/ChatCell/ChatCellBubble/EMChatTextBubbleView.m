...
//        _textLabel.preferredMaxLayoutWidth = TEXTLABEL_MAX_WIDTH;
...
+(CGFloat)heightForBubbleWithObject:(MessageModel *)object
{
    ...
    NSString *content = [NSString stringWithString:object.content];//ppp
    
    NSLog(@"%@", content);
    //    NSAttributedString *contentString = [[NSAttributedString alloc] initWithAttributedString:object.contentString];
