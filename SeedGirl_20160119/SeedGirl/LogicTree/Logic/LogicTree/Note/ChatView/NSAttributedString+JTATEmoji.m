...
{
    NSMutableAttributedString *parsedOutput = [[NSMutableAttributedString alloc] initWithString:string attributes:@{NSBaselineOffsetAttributeName : @(0), NSFontAttributeName:font}];
    ...
    for (NSTextCheckingResult* result in [matches reverseObjectEnumerator]) {
        ...
        textAttachment.bounds = CGRectMake(0, 0, emojiSize.width, emojiSize.height);
